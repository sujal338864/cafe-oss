...
async function diag() {
  const shopId = '63d27f88-81d3-463d-828e-5b7d6092008f'; // Assuming this is the shopId from previous logs
  
  // Try to find the shopId dynamically if the above is wrong
